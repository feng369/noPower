...
public class Sys_unit extends BaseModel implements Serializable {
    ...
    @Comment("所属机场")
    @ColDefine(type = ColType.VARCHAR, width = 20)
    private String unitairport;
    @One(field = "unitairport")
    ...
    public String getUnitairport(){ return unitairport;}

    public void setUnitairport(String unitairport){this.unitairport=unitairport;}
