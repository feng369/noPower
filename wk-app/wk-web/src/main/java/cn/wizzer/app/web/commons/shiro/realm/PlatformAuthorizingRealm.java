...
import cn.wizzer.app.base.modules.services.impl.BaseCnctobjServiceImpl;
import cn.wizzer.app.base.modules.services.impl.BasePersonServiceImpl;
...
public class PlatformAuthorizingRealm extends AuthorizingRealm {
    ...
    protected BasePersonService getPersonService(){
        if (Lang.isEmpty(basePersonService)) {
            Ioc ioc = Mvcs.getIoc();
            basePersonService = ioc.get(BasePersonServiceImpl.class);
        }
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token) throws AuthenticationException {
        ...
        base_person basePerson = getPersonService().getPersonInfo();
        ...
        SecurityUtils.getSubject().getSession(true).setAttribute("roleIdList", roleIdList);
        if(basePerson!=null) {
            SecurityUtils.getSubject().getSession(true).setAttribute("personid", basePerson.getId());
            SecurityUtils.getSubject().getSession(true).setAttribute("airportid", basePerson.getAirportid());
            SecurityUtils.getSubject().getSession(true).setAttribute("unitid", basePerson.getUnitid());
            SecurityUtils.getSubject().getSession(true).setAttribute("deptid", basePerson.getDeptid());
        }
