!function (e, t) {
    ...
    return function (e) {
        ...
        var a = n(1), s = n(4), l = n(5), u = function (e) {
        ...
        r.prototype.init = function () {
            var e = this, t = e.file, n = "string" == typeof t, r = /^data:/.test(t), i = new Image, l = document.createElement("canvas"), u = n ? t : URL.createObjectURL(t);
            if (e.img = i, e.blob = u, e.canvas = l, n ? e.fileName = r ? "base64.jpg" : t.split("/").pop() : e.fileName = t.name, !document.createElement("canvas").getContext)throw new Error("浏览器不支持canvas");
            ...
            return new a(function (i) {
                try {
                    l.getData("object" == typeof n ? n : t, function () {
                        e.orientation = l.getTag(this, "Orientation"), e.resize = e._getResize(), e.ctx = r.getContext("2d"), r.width = e.resize.width, r.height = e.resize.height, e.ctx.fillStyle = "#fff", e.ctx.fillRect(0, 0, r.width, r.height), u.oldIOS ? e._createBase64ForOldIOS().then(i) : e._createBase64().then(i)
                    })
                } catch (o) {
                    throw new Error(o)
                }
            ...
            var e = this, t = e.resize, r = e.img, i = e.canvas, o = e.ctx, s = e.defaults, l = e.orientation;
            switch (l) {
                case 3:
            ...
            return new a(function (e) {
                u.oldAndroid || u.mQQBrowser || !navigator.userAgent ? n.e(2, function (t) {
                        var n = [t(7)];
                        (function (t) {
        ...
        (function (e, r) {
            ...
            var o = n(3).nextTick, a = Function.prototype.apply, s = Array.prototype.slice, l = {}, u = 0;
        ...
        (function () {
            ...
            function c(e, t, n) {
                for (var r, i, o, a, s, l = new DataView(e), u = {}, c = t; t + n > c;)28 === l.getUint8(c) && 2 === l.getUint8(c + 1) && (a = l.getUint8(c + 2), a in b && (o = l.getInt16(c + 3), s = o + 5, i = b[a], r = h(l, c + 5, o), u.hasOwnProperty(i) ? u[i] instanceof Array ? u[i].push(r) : u[i] = [u[i], r] : u[i] = r)), c++;
                return u
            }

            function d(e, t, n, r, i) {
                var o, a, s, l = e.getUint16(n, !i), u = {};
                for (s = 0; l > s; s++)o = n + 12 * s + 2, a = r[e.getUint16(o, !i)], !a && p && console.log("Unknown tag: " + e.getUint16(o, !i)), u[a] = f(e, o, t, n, i);
                return u
            }
            ...
            function f(e, t, n, r, i) {
                ...
                switch (d) {
                    ...
                    case 7:
                        ...
                        for (o = f > 4 ? g : t + 8, a = [], l = 0; f > l; l++)a[l] = e.getUint8(o + l);
                        return a;
                    case 2:
                        return o = f > 4 ? g : t + 8, h(e, o, f - 1);
                    case 3:
                        if (1 == f)return e.getUint16(t + 8, !i);
                        for (o = f > 2 ? g : t + 8, a = [], l = 0; f > l; l++)a[l] = e.getUint16(o + 2 * l, !i);
                        return a;
                    case 4:
                        if (1 == f)return e.getUint32(t + 8, !i);
                        for (a = [], l = 0; f > l; l++)a[l] = e.getUint32(g + 4 * l, !i);
                        return a;
                    case 5:
                        if (1 == f)return u = e.getUint32(g, !i), c = e.getUint32(g + 4, !i), s = new Number(u / c), s.numerator = u, s.denominator = c, s;
                        for (a = [], l = 0; f > l; l++)u = e.getUint32(g + 8 * l, !i), c = e.getUint32(g + 4 + 8 * l, !i), a[l] = new Number(u / c), a[l].numerator = u, a[l].denominator = c;
                        return a;
                    case 9:
                        if (1 == f)return e.getInt32(t + 8, !i);
                        for (a = [], l = 0; f > l; l++)a[l] = e.getInt32(g + 4 * l, !i);
                        return a;
                    case 10:
                        if (1 == f)return e.getInt32(g, !i) / e.getInt32(g + 4, !i);
                        for (a = [], l = 0; f > l; l++)a[l] = e.getInt32(g + 8 * l, !i) / e.getInt32(g + 4 + 8 * l, !i);
                        return a
                }
            }
            ...
            function g(e, t) {
                ...
                if (8 > l)return p && console.log("Not valid TIFF data! (First offset less than 8)", e.getUint32(s + 4, !n)), !1;
                if (r = d(e, s, s + l, y, n), r.ExifIFDPointer) {
